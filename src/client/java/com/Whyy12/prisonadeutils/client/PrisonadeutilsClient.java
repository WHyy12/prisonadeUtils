...
public class PrisonadeutilsClient implements ClientModInitializer {
    ...
    private static void render(DrawContext context, RenderTickCounter tickCounter) {
        ...
        for (int i = 0; i < CalculatorState.ores.size(); i++) {
            ...
            context.drawTextWithShadow(textRenderer, CalculatorState.ores.get(i) + " - " + CalculatorState.amounts.get(i) * CalculatorState.mixAmount + ": " + pvs[0] + " Pvs, " + pvs[1] + " stacks, and " + stacks[1], 0, y, 0xFFFFFF);
            y += textRenderer.fontHeight;
        }
    }
}